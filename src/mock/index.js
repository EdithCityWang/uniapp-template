...
// 登录
apiRouter.post('/tenantUser/login', (req, res) => {
...
// 退出登录
apiRouter.post('/tenantUser/logOffForMobile', (req, res) => {
  res.send({
    state: 'success',
    message: '操作成功'
  })
...
// 地址列表
apiRouter.post('/addr/getAddrList', (req, res) => {
	res.send({
	  state: 'success',
	  message: '',
	  data: addrList
...
// 获取地区数据
apiRouter.post('/region/getRegionTree', (req, res) => {
	res.send({
		state: 'success',
		message: '',
		data: require('./city-data/CodeCity.json')
	})
})
